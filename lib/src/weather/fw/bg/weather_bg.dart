...
import 'package:auto_moto_dash/src/weather/fw/bg/weather_rain_snow_bg.dart';
import 'package:auto_moto_dash/src/weather/fw/bg/weather_thunder_bg.dart';
      ...
      child: ClipRect(
        child: Stack(
          children: [
            ...
            if (weatherType == FwWeatherType.thunder)
              WeatherThunderBg(weatherType: weatherType),
            if (weatherType == FwWeatherType.sunnyNight)
